		...
		<div class="col-md-12">
			<div class="card card-info">
			  <div class="card-header">
			  	...
			  	<div class="card-title pull-right"><a href="{{ route('artikel.create') }}">Tambah<i class="fa fa-plus"></i></a>
			  	</div>
			  </div>
			</div>
			 <script>
				  	...
				  	<tbody>
				  	  ...
				  	  <td>{{ $no++ }}</td>
				  	    ...
				  	    <td><a href="" class="thumbnail">
				  	    	<img src=" {{ asset ('/assets/img/artikel/' .$data->gambar. '' ) }}" width="100" height="100"></td></a>
